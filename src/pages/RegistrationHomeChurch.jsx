...
export default function RegistrationHomeChurch() {
    ...
    <main className="min-h-screen bg-off-white">
      ...
      <section className="px-4 py-16 md:py-24">
        <div className="max-w-7xl mx-auto border border-midnight-navy/10 bg-white p-3 md:p-6">
          <GoogleFormEmbed
            src="https://docs.google.com/forms/d/e/1FAIpQLSdvI1KqiZLG9JokCZNzLL60SIVkcW67tgabXVdoJeK_6s7kaw/viewform?embedded=true"
            height={800}
          />
        </div>
      </section>
